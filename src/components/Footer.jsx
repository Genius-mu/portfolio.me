    ...
    <>
      <footer className="w-full pt-5 pb-13 border-t border-black/20 flex flex-col gap-y-1 justify-center items-center">
        <p
          ...
          } font-light text-[14px] sm:text-[16px] leading-6`}
        >
        ...
        <nav className="flex gap-x-2">
          <Link
            ...
            className={`${
              dark ? "text-white/70" : "text-black/70"
            } py-2 hover:text-black rounded px-2 sm:px-4 transition-all duration-300 ease-in-out hover:bg-[#f1f1f1]/30 hover:backdrop-blur-2xl"
            target="_blank`}
          >
            <svg
